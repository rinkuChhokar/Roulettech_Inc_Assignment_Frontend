...
const Feature = React.forwardRef((props, ref)=>(
    <div ref={ref} className="bg-[#F7F7F7] text-[#333] font-[sans-serif]" id='FeatureSection'>
    <div className="max-w-6xl mx-auto py-16 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-md:max-w-md mx-auto">
        <div className="bg-white rounded-lg overflow-hidden shadow-lg">
          <div className="p-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 mb-4" viewBox="0 0 32 32">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-lg">
          <div className="p-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 mb-4" viewBox="0 0 682.667 682.667">
              <defs>
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-lg">
          <div className="p-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 mb-4" viewBox="0 0 24 24">
