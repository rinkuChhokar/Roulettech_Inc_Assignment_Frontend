...
import UserAvatar from "/public/images/team.jpg"

const About = React.forwardRef((props, ref) => (
  <div ref={ref} className="font-[sans-serif] text-[#333]" id="AboutSection">
    <div className="lg:max-w-5xl max-w-3xl mx-auto">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl font-extrabold pt-10">Meet our team</h2>
        <p className="text-sm mt-4 leading-relaxed">
          Meet our team of professionals to serve you.
        </p>
      </div>
      <div className="grid lg:grid-cols-4 md:grid-cols-3 gap-x-8 gap-y-10 max-md:justify-center mt-12">
        {[1, 1, 1, 1].map((item) => (
          <>
            <div className="border rounded-md overflow-hidden max-w-[280px]">
              <img
                src={UserAvatar}
